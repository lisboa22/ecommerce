...
<!--
    Lisbo@Info Store by lisboainfo.com.br
-->
<html lang="pt-br">
  <head>
    <meta charset="utf-8">
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="/"><i class="fa fa-bars"></i> Categorias  <i class="fa fa-chevron-down"></i></a></li>
